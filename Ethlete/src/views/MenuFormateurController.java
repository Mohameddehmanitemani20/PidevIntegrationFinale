...
public class MenuFormateurController implements Initializable {
    ...
    private void aff(ActionEvent event) throws IOException {
            ...
            stage.setTitle("Consultation des affectations");
    ...
    private void stat(ActionEvent event) throws IOException {
            ...
            stage.initModality(Modality.APPLICATION_MODAL);
            stage.initStyle(StageStyle.UNDECORATED);
            stage.setTitle("Consultation des statistiques");
            stage.setScene(new Scene(root1));  
            stage.show();
    ...
    @FXML
    private void art(ActionEvent event) throws IOException {
                       FXMLLoader fxmlLoader =new FXMLLoader(getClass().getResource("../views/FXMLajouterarticle.fxml"));
