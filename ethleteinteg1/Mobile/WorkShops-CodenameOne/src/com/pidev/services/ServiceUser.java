...
import com.pidev.entities.SessionManager;
import com.pidev.entities.User;
import com.pidev.gui.NewsfeedForm;
import com.pidev.gui.ProfileForm;
...
//t.setRoles(role.get(0));
   ...
   public ArrayList<User> getAllUser(){
    ...
    public boolean BanUser(float id) {
        ...
        String url = Statics.BASE_URL + "/user/ban?id="+id;
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
    ...
    public boolean UnBanUser(float id) {
        ...
        String url = Statics.BASE_URL + "/user/unban?id="+id;
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
