...
class FournisseurController extends AbstractController
{
    ...
    /**
     * @Route("/{idf}", name="app_fournisseur_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idf}/edit", name="app_fournisseur_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idf}", name="app_fournisseur_delete", methods={"POST"})
     */
    public function delete(Request $request, Fournisseur $fournisseur, FournisseurRepository $fournisseurRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$fournisseur->getIdf(), $request->request->get('_token'))) {
